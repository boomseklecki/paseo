...
export const ar: TranslationResources = {
  ...
  settings: {
    ...
    rules: {
      ...
      hostsLabel: "المضيفات",
      hostsHint: "الأجهزة التي تُطبَّق عليها هذه القاعدة. تُحفظ بشكل منفصل على كل جهاز.",
      hostToggle: "احفظ هذه القاعدة على {{host}}",
      hostsRequired: "اختر مضيفًا واحدًا على الأقل.",
      hostsSucceeded: "تم الحفظ على {{hosts}}.",
      hostFailed: "{{host}}: {{reason}}",
      hostUnreachable: "غير متصل.",
      featureToggleHost: "تشغيل القواعد على {{host}}",
      tryItLabel: "جرّبها",
      tryItPlaceholder: "اكتب شيئًا لتجربته",
      verdicts: {
        fires: "هذه القاعدة ستُفعَّل.",
        "condition-false": "لن تُفعَّل على ذلك.",
        disabled: "هذه القاعدة مُطفأة.",
        "unknown-event": "هذا الإصدار لا يعرف تلك اللحظة.",
        "trigger-not-at-this-event": "هذا المشغّل بلا معنى في هذه اللحظة.",
        "outcome-not-at-this-event": "هذه النتيجة لا يمكن أن تحدث في هذه اللحظة.",
      },
      neverFires: "لا تُفعَّل أبدًا",
      differs: "مختلفة",
      ...
      examples: {
        ...
        "notify-on-failed-turn": {
          label: "أبلغني عند فشل دور في جلسة مكلفة",
          description: "فقط بعد أن تتجاوز الجلسة كلفة تستحق مقاطعتك.",
        },
        "notify-agent-left-idle": {
          label: "أبلغني عن وكيل تُرك بلا عمل",
          description: "الوكيل الذي ينتظرك يبدو تمامًا كوكيل انتهيت منه.",
        },
        "notify-context-pressure": {
          label: "أبلغني أن المحادثة أوشكت على الامتلاء",
          description: "يُفحص عند نهاية الدور ويصل إلى هاتفك لا إلى شاشة لا تنظر إليها.",
        },
        "handoff-before-compaction": {
          label: "اكتب التسليم قبل أن يُضغط المحادثة، وأخبرني",
          description: "يكتب وكيل خفي الملخّص الذي كنت ستكتبه بنفسك، ويصلك إشعار بوجوده.",
        },
        "fork-on-slash-fork": {
          label: "تفريع المحادثة عند /fork",
          description:
            "زر التفريع كاختصار تختاره: كتابة /fork تنقل المحادثة إلى واحدة جديدة بدل إرسالها.",
        },
        "start-fresh-when-full": {
          label: "افتح محادثة جديدة عندما تمتلئ هذه",
          description: "تُفتح محادثة جديدة بجوارها دون نقل أي شيء — استخدمها مع قاعدة التسليم.",
        },
        "retry-after-a-failed-turn": {
          label: "أعد المحاولة بعد عشر دقائق من فشل الدور",
          description: "معظم حالات الفشل حدّ معدل أو عارض، والحل هو الانتظار لا القراءة.",
        },
      ...
      moveDown: "نقل لأسفل",
      remove: "إزالة",
      removeConfirmTitle: "إزالة هذه القاعدة؟",
      ...
      outcomeRequired: "اختر نتيجة واحدة على الأقل",
      outcomeDuplicate: "لا يمكن إدراج النتيجة نفسها مرتين",
