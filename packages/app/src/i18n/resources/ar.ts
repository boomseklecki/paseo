...
export const ar: TranslationResources = {
  ...
  settings: {
    ...
    sections: {
      ...
      appearance: "مظهر",
      editor: "المحرر",
      preSendChecks: "فحوصات ما قبل الإرسال",
    ...
    preSendChecks: {
      sectionTitle: "فحوصات ما قبل الإرسال",
      sectionHint:
        "قواعد تُفحص قبل مغادرة الرسالة لحقل الكتابة. التحذير يرسل الرسالة على أي حال، أما الحظر فيحتفظ بها حتى لا تفقد ما كتبته.",
      hostsLabel: "المضيفات",
      ...
      featureToggleHost: "افحص الرسائل قبل الإرسال على {{host}}",
      differs: "مختلفة",
      ...
      featureToggleTitle: "فحص الرسائل قبل إرسالها",
      addRule: "إضافة قاعدة",
