export const en = {
  ...
  settings: {
    ...
    preSendChecks: {
      sectionTitle: "Pre-send checks",
      sectionHint:
        "Rules checked before a message leaves the composer. A warning still sends; a block holds the message so you keep what you typed.",
      hostsLabel: "Hosts",
      ...
      featureToggleHost: "Check messages before sending on {{host}}",
      differs: "Differs",
      ...
      featureToggleTitle: "Check messages before sending",
      addRule: "Add rule",
      editRule: "Edit rule",
