export const en = {
  ...
  settings: {
    ...
    rules: {
      ...
      hostsLabel: "Hosts",
      hostsHint: "Which machines run this rule. It is stored separately on each one.",
      hostToggle: "Store this rule on {{host}}",
      hostsRequired: "Pick at least one host.",
      hostsSucceeded: "Saved on {{hosts}}.",
      hostFailed: "{{host}}: {{reason}}",
      hostUnreachable: "Not connected.",
      featureToggleHost: "Run rules on {{host}}",
      tryItLabel: "Try it",
      tryItPlaceholder: "Type something to test against",
      verdicts: {
        fires: "This rule would fire.",
        "condition-false": "This rule would not fire on that.",
        disabled: "This rule is switched off.",
        "unknown-event": "This build does not know that moment.",
        "trigger-not-at-this-event": "That trigger means nothing at this moment.",
        "outcome-not-at-this-event": "That outcome cannot happen at this moment.",
      },
      neverFires: "Never fires",
      differs: "Differs",
      loading: "Loading rules...",
      emptyState: "No rules. Sends are never held.",
      loadFailed: "Could not load rules.",
      ...
      wordingHint: "What you are told when this fires.",
      tokensLabel: "Tokens:",
      tokenMessage: "what you typed",
      tokenValue: "the measured value",
      tokenThreshold: "the value the rule compares against",
      tokenDuration: "how long, for a time rule",
