...
export const es: TranslationResources = {
  ...
  settings: {
    ...
    sections: {
      ...
      editor: "Editor",
      preSendChecks: "Comprobaciones previas al envío",
      shortcuts: "Atajos",
    ...
    preSendChecks: {
      sectionTitle: "Comprobaciones previas al envío",
      sectionHint:
        "Reglas que se comprueban antes de que un mensaje salga del editor. Una advertencia envía igualmente; un bloqueo retiene el mensaje para que conserve lo que escribió.",
      hostsLabel: "Hosts",
      ...
      featureToggleHost: "Comprobar los mensajes antes de enviarlos en {{host}}",
      differs: "Difiere",
      ...
      featureToggleTitle: "Comprobar los mensajes antes de enviarlos",
