...
export const es: TranslationResources = {
  ...
  settings: {
    ...
    preSendChecks: {
      sectionTitle: "Reglas",
      sectionHint:
        "Las reglas se ejecutan en los momentos que elija: antes de enviar un mensaje, al terminar o fallar un turno, o cuando un agente queda inactivo.",
      hostsLabel: "Hosts",
      hostsHint: "En qué máquinas se aplica esta regla. Se guarda por separado en cada una.",
      hostToggle: "Guardar esta regla en {{host}}",
      hostsRequired: "Elija al menos un host.",
      hostsSucceeded: "Guardada en {{hosts}}.",
      hostFailed: "{{host}}: {{reason}}",
      hostUnreachable: "Sin conexión.",
      featureToggleHost: "Ejecutar reglas en {{host}}",
      tryItLabel: "Probar",
      tryItPlaceholder: "Escriba algo para probar",
      verdicts: {
        fires: "Esta regla se activaría.",
        "condition-false": "Esta regla no se activaría con eso.",
        disabled: "Esta regla está desactivada.",
        "unknown-event": "Esta versión no conoce ese momento.",
        "trigger-not-at-this-event": "Ese activador no significa nada en este momento.",
        "outcome-not-at-this-event": "Ese resultado no puede ocurrir en este momento.",
      },
      neverFires: "Nunca se activa",
      differs: "Difiere",
      ...
      featureToggleTitle: "Ejecutar reglas",
      addRule: "Añadir regla",
      editRule: "Editar regla",
      toggleRule: "Activar o desactivar esta regla",
      ...
      examples: {
        ...
        "start-fresh-when-full": {
          label: "Abrir una conversación nueva cuando esta se llene",
          description:
        ...
        "warn-context-nearly-full": {
          ...
          description:
            "Al 80 %, mientras terminar la idea siga saliendo más barato que reiniciarla.",
        },
        "warn-session-cost": {
          label: "Avisar al superar un coste de sesión",
          description: "Un aviso y no un bloqueo, porque la cifra que importa cambia cada día.",
        },
        "block-cold-prompt-cache": {
          label: "Bloquear cuando la caché de prompt se enfríe",
          description: "Pasada una hora, el siguiente turno reprocesa toda la conversación.",
        },
      },
      addTitle: "Nueva regla",
      editTitle: "Editar regla",
      moveUp: "Subir",
      moveDown: "Bajar",
      remove: "Eliminar",
      removeConfirmTitle: "¿Eliminar esta regla?",
