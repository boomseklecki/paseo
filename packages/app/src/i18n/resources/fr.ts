...
export const fr: TranslationResources = {
  ...
  settings: {
    ...
    preSendChecks: {
      ...
      tryItLabel: "Essayer",
      tryItPlaceholder: "Saisissez quelque chose à tester",
      verdicts: {
        fires: "Cette règle se déclencherait.",
        "condition-false": "Cette règle ne se déclencherait pas là-dessus.",
        disabled: "Cette règle est désactivée.",
        "unknown-event": "Cette version ne connaît pas ce moment.",
        "trigger-not-at-this-event": "Ce déclencheur n'a aucun sens à ce moment.",
        "outcome-not-at-this-event": "Ce résultat est impossible à ce moment.",
      },
      neverFires: "Ne se déclenche jamais",
      differs: "Diverge",
      ...
      examples: {
        ...
        "warn-session-cost": {
          label: "Avertir au-delà d'un coût de session",
          description:
            "Un avertissement plutôt qu'un blocage, car le seuil pertinent change chaque jour.",
        },
        "block-cold-prompt-cache": {
          label: "Bloquer quand le cache de prompt est froid",
          description: "Au-delà d'une heure, le tour suivant retraite toute la conversation.",
        },
      },
      ...
      moveDown: "Descendre",
      remove: "Supprimer",
      removeConfirmTitle: "Supprimer cette règle ?",
