...
export const ja: TranslationResources = {
  ...
  settings: {
    ...
    preSendChecks: {
      sectionTitle: "送信前チェック",
      sectionHint:
        "メッセージが入力欄を離れる前に確認されるルールです。警告ならそのまま送信し、ブロックならメッセージを保持するので入力した内容は残ります。",
      hostsLabel: "ホスト",
      ...
      featureToggleHost: "{{host}} で送信前にメッセージを確認",
      differs: "相違あり",
      loading: "ルールを読み込み中...",
      ...
      featureToggleTitle: "送信前にメッセージをチェックする",
      addRule: "ルールを追加",
      editRule: "ルールを編集",
