...
export const ja: TranslationResources = {
  ...
  settings: {
    ...
    preSendChecks: {
      ...
      hostsLabel: "ホスト",
      hostsHint: "このルールを適用するマシンです。各マシンに個別に保存されます。",
      hostToggle: "このルールを {{host}} に保存",
      hostsRequired: "ホストを1つ以上選んでください。",
      hostsSucceeded: "{{hosts}} に保存しました。",
      hostFailed: "{{host}}: {{reason}}",
      hostUnreachable: "接続されていません。",
      featureToggleHost: "{{host}} でルールを実行",
      tryItLabel: "試す",
      tryItPlaceholder: "試す内容を入力",
      verdicts: {
        fires: "このルールは発火します。",
        "condition-false": "その内容では発火しません。",
        disabled: "このルールはオフです。",
        "unknown-event": "このビルドはそのタイミングを知りません。",
        "trigger-not-at-this-event": "そのトリガーはこのタイミングでは意味を持ちません。",
        "outcome-not-at-this-event": "その結果はこのタイミングでは起こりません。",
      },
      neverFires: "発火しません",
      differs: "相違あり",
      loading: "ルールを読み込み中...",
      ...
      outcomeLabel: "結果",
      wordingLabel: "文面",
      wordingHint: "これが発火したときに伝えられる内容です。",
      tokensLabel: "トークン:",
      tokenMessage: "入力した内容",
      tokenValue: "測定値",
      tokenThreshold: "ルールが比較する値",
      tokenDuration: "経過時間（時間のルールの場合）",
