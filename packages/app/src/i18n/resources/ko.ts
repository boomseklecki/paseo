...
export const ko: TranslationResources = {
  ...
  settings: {
    ...
    preSendChecks: {
      ...
      hostsLabel: "호스트",
      hostsHint: "이 규칙을 적용할 컴퓨터입니다. 각 호스트에 따로 저장됩니다.",
      hostToggle: "이 규칙을 {{host}}에 저장",
      hostsRequired: "호스트를 하나 이상 선택하세요.",
      hostsSucceeded: "{{hosts}}에 저장했습니다.",
      hostFailed: "{{host}}: {{reason}}",
      hostUnreachable: "연결되지 않았습니다.",
      featureToggleHost: "{{host}}에서 규칙 실행",
      tryItLabel: "시험",
      tryItPlaceholder: "시험할 내용을 입력",
      verdicts: {
        fires: "이 규칙은 실행됩니다.",
        "condition-false": "그 내용으로는 실행되지 않습니다.",
        disabled: "이 규칙은 꺼져 있습니다.",
        "unknown-event": "이 빌드는 그 시점을 알지 못합니다.",
        "trigger-not-at-this-event": "그 트리거는 이 시점에서 의미가 없습니다.",
        "outcome-not-at-this-event": "그 결과는 이 시점에 일어날 수 없습니다.",
      },
      neverFires: "실행되지 않음",
      differs: "다름",
      loading: "규칙 불러오는 중...",
      ...
      examples: {
        ...
        "handoff-before-compaction": {
          label: "대화가 압축되기 전에 인수인계를 쓰고, 알리기",
          description: "직접 썼을 요약을 숨은 에이전트가 쓰고, 알림이 그것이 있음을 알려줍니다.",
        },
        "fork-on-slash-fork": {
          label: "/fork로 대화 분기하기",
          description:
      ...
      moveDown: "아래로 이동",
      remove: "제거",
      removeConfirmTitle: "이 규칙을 제거할까요?",
      ...
      outcomeRequired: "결과를 하나 이상 고르세요",
      outcomeDuplicate: "같은 결과는 한 번만 넣을 수 있습니다",
      addOutcome: "결과 추가",
      removeOutcome: "이 결과 제거",
