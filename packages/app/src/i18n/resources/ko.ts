...
export const ko: TranslationResources = {
  ...
  settings: {
    ...
    preSendChecks: {
      sectionTitle: "전송 전 검사",
      sectionHint:
        "메시지가 입력창을 떠나기 전에 확인하는 규칙입니다. 경고는 그대로 전송하고, 차단은 메시지를 붙잡아 입력한 내용을 지켜 줍니다.",
      hostsLabel: "호스트",
      ...
      featureToggleHost: "{{host}}에서 보내기 전에 메시지 확인",
      differs: "다름",
      loading: "규칙 불러오는 중...",
      ...
      featureToggleTitle: "보내기 전에 메시지 검사",
      addRule: "규칙 추가",
      editRule: "규칙 편집",
