...
export const ptBR: TranslationResources = {
  ...
  settings: {
    ...
    preSendChecks: {
      ...
      hostsLabel: "Hosts",
      hostsHint: "Em quais máquinas esta regra vale. Ela é salva separadamente em cada uma.",
      hostToggle: "Salvar esta regra em {{host}}",
      hostsRequired: "Escolha pelo menos um host.",
      hostsSucceeded: "Salva em {{hosts}}.",
      hostFailed: "{{host}}: {{reason}}",
      hostUnreachable: "Sem conexão.",
      featureToggleHost: "Executar regras em {{host}}",
      tryItLabel: "Testar",
      tryItPlaceholder: "Digite algo para testar",
      verdicts: {
        fires: "Esta regra dispararia.",
        "condition-false": "Esta regra não dispararia com isso.",
        disabled: "Esta regra está desligada.",
        "unknown-event": "Esta versão não conhece esse momento.",
        "trigger-not-at-this-event": "Esse gatilho não significa nada neste momento.",
        "outcome-not-at-this-event": "Esse resultado não pode acontecer neste momento.",
      },
      ...
      featureToggleTitle: "Executar regras",
      ...
      remove: "Remover",
      removeConfirmTitle: "Remover esta regra?",
