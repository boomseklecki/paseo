...
export const ptBR: TranslationResources = {
  ...
  settings: {
    ...
    sections: {
      ...
      editor: "Editor",
      preSendChecks: "Verificações de pré-envio",
      shortcuts: "Atalhos",
    ...
    preSendChecks: {
      sectionTitle: "Verificações de pré-envio",
      sectionHint:
        "Regras verificadas antes de a mensagem sair do compositor. Um aviso ainda envia; um bloqueio retém a mensagem para você não perder o que digitou.",
      hostsLabel: "Hosts",
      ...
      featureToggleHost: "Verificar mensagens antes de enviar em {{host}}",
      differs: "Divergente",
