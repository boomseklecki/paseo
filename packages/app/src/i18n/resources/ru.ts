...
export const ru: TranslationResources = {
  ...
  settings: {
    ...
    sections: {
      ...
      editor: "Редактор",
      preSendChecks: "Проверки перед отправкой",
      shortcuts: "Ярлыки",
    ...
    preSendChecks: {
      sectionTitle: "Проверки перед отправкой",
      sectionHint:
        "Правила, которые проверяются до того, как сообщение уйдёт из поля ввода. Предупреждение всё равно отправляет; блокировка удерживает сообщение, и набранный текст сохраняется.",
      hostsLabel: "Хосты",
      ...
      featureToggleHost: "Проверять сообщения перед отправкой на {{host}}",
      differs: "Расходится",
