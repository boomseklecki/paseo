...
export const ru: TranslationResources = {
  ...
  settings: {
    ...
    preSendChecks: {
      ...
      outcomeLabel: "Итог",
      wordingLabel: "Формулировка",
      wordingHint: "Что вам сообщат, когда правило сработает.",
      tokensLabel: "Токены:",
      tokenMessage: "то, что вы напечатали",
      tokenValue: "измеренное значение",
      tokenThreshold: "значение, с которым сравнивает правило",
      tokenDuration: "сколько времени, для правила о времени",
