...
export const zhCN: TranslationResources = {
  ...
  settings: {
    ...
    preSendChecks: {
      ...
      hostsLabel: "主机",
      hostsHint: "该规则在哪些机器上生效。它会分别保存在每台机器上。",
      hostToggle: "将该规则保存到 {{host}}",
      hostsRequired: "请至少选择一台主机。",
      hostsSucceeded: "已保存到 {{hosts}}。",
      hostFailed: "{{host}}：{{reason}}",
      hostUnreachable: "未连接。",
      featureToggleHost: "在 {{host}} 上运行规则",
      tryItLabel: "试一下",
      tryItPlaceholder: "输入要测试的内容",
      verdicts: {
        fires: "这条规则会触发。",
        "condition-false": "用这个内容不会触发。",
        disabled: "这条规则已关闭。",
        "unknown-event": "此版本不认识那个时机。",
        "trigger-not-at-this-event": "该触发条件在这个时机没有意义。",
        "outcome-not-at-this-event": "该结果在这个时机无法发生。",
      },
      neverFires: "永不触发",
      differs: "不一致",
      loading: "正在加载规则...",
      ...
      examples: {
        ...
        "handoff-before-compaction": {
          label: "在对话压缩前写好交接，并告知",
          description: "隐藏代理写下你本来要自己写的摘要，并由通知告诉你它已经在那里。",
        },
        "fork-on-slash-fork": {
          label: "用 /fork 分叉对话",
      ...
      outcomeLabel: "结果",
      wordingLabel: "措辞",
      wordingHint: "这条规则触发时你会看到的内容。",
      tokensLabel: "标记：",
      tokenMessage: "你输入的内容",
      tokenValue: "测得的值",
      tokenThreshold: "规则用来比较的值",
      tokenDuration: "多长时间（用于时间规则）",
      defaultMessageHint: "使用内置文案",
      triggerRequired: "请选择触发条件",
      operatorRequired: "请选择比较方式",
      outcomeRequired: "请至少选择一个结果",
      outcomeDuplicate: "同一个结果只能列出一次",
      addOutcome: "添加结果",
      removeOutcome: "移除此结果",
