import type { RuleExample } from "@getpaseo/protocol/rules/types";
import { isPlainOutcomeKind } from "@getpaseo/protocol/rules/types";
 ...
 */
export function listRuleExamples(
  examples: readonly RuleExample[] = RULE_EXAMPLES,
  outcomeKinds: readonly string[] = RULE_OUTCOME_DESCRIPTORS.map((descriptor) => descriptor.kind),
): RuleExample[] {
