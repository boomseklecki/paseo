...
export interface RuleIdleWatcherOptions {
 ...
 */
export class RuleIdleWatcher {
  private readonly options: RuleIdleWatcherOptions;
  private readonly intervalMs: number;
  private readonly now: () => number;
  private timer: NodeJS.Timeout | null = null;
  private sweeping = false;

  constructor(options: RuleIdleWatcherOptions) {
