...
import {
  ...
  wasCreatedByRule,
  type RuleOutcomeResult,
  type RuleOutcomeRequest,
} from "./types.js";
...
export class StartOutcome {
  ...
  constructor(options: { manager: AgentManager; logger: Logger }) {
    ...
    this.logger = options.logger.child({ module: "rules", outcome: "start" });
  }
 ...
 */
function readOpening(request: RuleOutcomeRequest): string {
